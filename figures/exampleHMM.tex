...
\ncline[linestyle=dashed]{random}{erandom}

\NODE(3,-2.5){exone}{white}{$1$}
\BNODE(3,-3.5){eexone}{white}{$(0.1,0.2,0.3,0.4)$}
\ncline[linestyle=dashed]{exone}{eexone}

\NODE(-1,-2.5){intron}{white}{$0$}
\BNODE(-1,-3.5){eintron}{white}{$(0.5,0.2,0.25,0.05)$}
\ncline[linestyle=dashed]{intron}{eintron}
