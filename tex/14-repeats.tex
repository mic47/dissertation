...
\end{reformulate*}
\section{Methods for finding and aligning tandem repeats}
\begin{reformulate*}
...
\abbreviation{Tandem repeat finder}{TRF} is probable the most used tool for
finding tandem repeats.

\subsection{TANTAN}

Tantan is high-order HMM aimed for finding tandem repeats. It consists from
...
\section{Models}\label{SECTION:REPMODELS}
\begin{reformulate*}
