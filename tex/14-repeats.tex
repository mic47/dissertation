...
posterior algorithm with soft masking. Apart from the 3-state posterior
...
its scoring scheme was not tailored to our method. Using soft masking produced
...
bases with N symbol, that represents unknown base. For decoding we used both
the Viterbi and the posterior decoding.  Apart from  using correct intervals,
the best performing masking was used with non-overlapping repeats from TRF.
