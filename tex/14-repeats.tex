...
\def\S{$^{\star}$}
\begin{reformulate*}
Accuracy of several decoding methods on simulated data.
\begin{itemize}
...
\end{tabular}
\end{center}
\caption{Accuracy for standard algorithms and other tools on simulated data.}\label{TABLE:OTHER}
\end{table*}
...
\end{tabular}
\end{center}
\caption{Accuracy of decoding method using simple 3-state HMM and masking. The best and the second best are bold. }\label{TABLE:3STATEMASK}
\end{table*}
