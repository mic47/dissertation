...
those values effectively and describe \correction{four}{Subject to change}
...
($i>0$)
have only $1$ predecessor.  

{\it Crochemore et al.} gave algorithm how to compute $DIST$ and $OUT$ matrix
for block \nocite{Crochemore2002} $B_{i,j}$ from its predecessors in time
