...
We will present variant $O(nm\log n)$ algorithm for concave gap functions which
...
maximum. $L_j$ will called \firstUseOf{candidate list} and members of $L_j$ will be
called \firstUseOf{candidates}. $L_j$ is candidate list for computing $M[i,j]$.
