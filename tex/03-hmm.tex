...
Chceckpointing can be used to decrease memory complexity of the Viterbi algorithm wi
th backtracing procedure and the Posterior decoding to $O(\sqrt n m)$.
Similarly, this trick can be used to reduce memory complexity of algorithm for
pHMMs to $O(n\sqrt n m)$ where $n$ is the length of the longer sequences and $m$
is the number of states of HMM.

\subsubsection{One-dimensional HMMs}
