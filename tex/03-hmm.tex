...
Where roots of the trees are vertices $(0,v),v\in V$. Most probable state path
of a sequence $X$ of the length $n$ and ending in vertex $v$ corresponds to the
path from vertex $(n-1,v)$ to root of it's tree. During computation of the
Viterbi algorithm,
