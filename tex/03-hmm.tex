...
We can compute these values in $O(nm^2)$ time and $O(nm)$ memory. Later we will
discuss possible algorithmic improvements of this algorithm.
%By
...
Initial distribution is set to $I(w_1)=I(w_2)=0.3, I(v)=0.4, I(e)=0$.
...
V\cup\{*\}$. $*$ means missing information in state path.

\subsection{Fully Labeled Data}
At first we consider data without missing information. 
