...
the most probable state path. All mentioned compression schemes has property,
that for every good string $x$ there are also two good strings $x_1,x_2$ such
that $x=x_1x_2$. Therefore 
...
Online Viterbi algorithm is different approach to reduce memory complexity of
...
Where roots of trees are vertices $(0,v),v\in V$. If there is leaf in the tree
$F$, then  
