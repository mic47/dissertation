...
four problems: \firstUseOf{the most probable set}, \firstUseOf{the most probable
footprint}, \firstUseOf{existence of a path} and \firstUseOf{the most probable
restriction}. The latter two problems are variants of the most probable set.
...
\begin{definition}[Existence of a path problem]
...
\begin{theorem}
The most probable footprint problem is NP-hard.
...
theorem \ref{THEOREM::NPSET} again. Finally we show proof of theorems
\ref{THEOREM::NPEXIST} and \ref{THEOREM::NPREST}.
