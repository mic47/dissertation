...
\todo{Brona: Pridaj zmienku o Jakubovom clanku, kde to robili a zhrnutie nasich
vysledkov (experimenty, np-tazkost, formalizovanie problemu -> z konca 5.1}
...
\end{theorem}
\todo{States alebo labels? Pre labels trivialne redukcia z most probable labeling}
...
\end{cases}$$
\fi
\todo{Ako najdem vysledok?, velkost cislel?  -- ze vieme tieto cisla reprezentovat v tozumnom tvare Pozri koniec 5.6, trosku zdovodni}
...
\todo{Fixed parameter? (Sum results from dyn prog for set)}
