...
%also choose different criteria to select such set). 
%In informal and more general way, 
...
silent, the leftmost shaded state is init state. Final state is the rightmost
...
state and global final state to connect profiles in parallel.  Column numbers of
